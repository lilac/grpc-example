...
var PROTO_PATH = __dirname + '/protobuf/route_guide.proto';
...
const filepath = 'route_guide.proto';
const proto = grpc.load({ root: __dirname + '/protobuf', file: filepath });

var routeguide = proto.routeguide;
